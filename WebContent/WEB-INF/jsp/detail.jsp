...
<div class="navbar">
    <ul>
        <li><a href="../../college/person_index">${sessionScope.user}</a></li>
        <li><a href="#">简历</a></li>
...
<ul class="container">
    ...
    <li class="qq"><img style="width:50px;height:50px;" src="<%=basePath %>/img/11.jpg"></li>
</ul>
<div class="main">
    <div class="head">
        <div class="JobName" id="${myJobListinfo.id}">${myJobListinfo.jobName}</div>
        ...
        <button class="btn btn-primary" id="apply_position">申请职位</button>
    </div>
