...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath %>css/companys.css">
    <title>企业列表</title>
</head>
<body>
<div class="navbar">
    <ul>
        <li><a href="../college/person_info">${sessionScope.user }</a></li>
        <li><a href="#">简历</a></li>
        <li><a href="#">收藏</a></li>
            ...
            <ul class="info">
                <c:forEach items="${companyList}" var="item">
                    <li>
                        ...
                        <a href="${item.id}/Companydetail">${item.shotName }</a>
                        <div class="locations">${item.divisionName}|${item.industry}|${item.type}|${item.staffSize}</div>
                        <div class="btns">
                            <button class="btn btn-primary" value="收藏公司">收藏公司</button>
                        </div>
